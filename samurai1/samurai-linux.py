...
samuraimap[1] = {
    'name': 'Update Samurai',
    'cmd': 'curl -L https://raw.githubusercontent.com/mirageglobe/samurai/master/samurai/install.sh | bash',
    'responsesuccess': ''
    }
...
samuraimap[3] = {
    'name': 'Toggle ShowCmd mode',
    'cmd': '',
    'responsesuccess': ''
    }

samuraimap[4] = {
    'name': 'Clear screen and show menu',
    'cmd': 'clear',
...
samuraimap[10] = {
    'name': 'Change my login password',
    'cmd': 'passwd',
    'responsesuccess': ''
    }

samuraimap[11] = {
    'name': 'Update ubuntu and cleanup cache',
...
samuraimap[30] = {
    'name': 'Install linuxbrew (homebrew for linux)',
...
samuraimap[31] = {
    'name': 'Install nodejs, NPM via NVM',
...
samuraimap[40] = {
    'name': 'Install clamav and clam daemon',
...
samuraimap[50] = {
    'name': 'Install sqlite (for all)',
    'cmd': 'sudo apt-get install sqlite',
    'responsesuccess': ''
    }

samuraimap[51] = {
    'name': 'Install mongodb 3.0 (for ubuntu 14.04.x trusty)',
...
samuraimap[52] = {
    'name': 'Install mariadb 10.0 (for ubuntu 14.04.x trusty)',
...
samuraimap[60] = {
    'name': 'Install nginx - ppa latest stable (for all)',
...
samuraimap[70] = {
    'name': 'Install AV suite (avconv pngquant graphicsmagick)',
